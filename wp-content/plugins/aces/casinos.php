...
function aces_casinos_detailed_tc_fields() {
    add_meta_box( 'aces_casinos_detailed_tc_meta_box',
        esc_html__( 'Detailed T&Cs for casino listing tables', 'aces' ),
...
function aces_casinos_detailed_tc_display_meta_box( $casino ) {
	...
	$casino_detailed_tc = get_post_meta( $casino->ID, 'casino_detailed_tc', true );
	$casino_detailed_tc_allowed_html = array(
		'a' => array(
			'href' => true,
			'title' => true,
			'target' => true,
...
<div class="components-base-control casino_detailed_tc">
	<div class="components-base-control__field">
		<label class="components-base-control__label" for="casino_detailed_tc-0">
			<?php esc_html_e( 'Detailed T&Cs', 'aces' ); ?>
		</label>
		<textarea class="components-textarea-control__input" id="casino_detailed_tc-0" rows="4" name="casino_detailed_tc" style="display: block; margin-bottom: 10px; width:100%;"><?php echo wp_kses($casino_detailed_tc, $casino_detailed_tc_allowed_html); ?></textarea>
		<div>
			<small><?php esc_html_e( 'Allowed HTML tags: a, br, em, strong, span, p.', 'aces' ); ?></small>
		</div>
	</div>
</div>
