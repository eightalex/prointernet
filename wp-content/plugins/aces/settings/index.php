...
<div class="wrap">
    ...
    <div style="padding-bottom: 10px;">
        <?php esc_html_e( 'ACES Gambling plugin by', 'aces' ); ?> <a href="<?php echo esc_url( __( 'https://space-themes.com/', 'aces' ) ); ?>" title="<?php esc_attr_e( 'Space-Themes.com', 'aces' ); ?>" target="_blank"><?php esc_html_e( 'Space-Themes.com', 'aces' ); ?></a>
    </div>
