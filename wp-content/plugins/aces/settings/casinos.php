...
function aces_casinos_settings_init() {
    ...
    register_setting( 'aces_casinos_tab', 'casinos_devices_title', 'esc_attr');
    ...
    register_setting( 'aces_casinos_tab', 'casinos_owner_title', 'esc_attr');
    ...
    register_setting( 'aces_casinos_tab', 'casinos_est_title', 'esc_attr');
    ...
    register_setting( 'aces_casinos_tab', 'casino_device_slug', 'esc_attr');
    ...
    register_setting( 'aces_casinos_tab', 'casino_owner_slug', 'esc_attr');
    ...
    register_setting( 'aces_casinos_tab', 'casino_est_slug', 'esc_attr');
    ...
    add_settings_field(
        ...
        'aces_rating_stars_number_callback',
        'aces_casinos_tab',
        'aces_casinos_tab_rating_titles' 
    );
    register_setting( 'aces_casinos_tab', 'aces_rating_stars_number', 'esc_attr');

    function aces_rating_stars_number_callback() {
    ...
    add_settings_field(
        ...
        'aces_textfield_read_review_title_callback',
        'aces_casinos_tab',
        'aces_casinos_tab_other_settings',
        array(
    ...
    register_setting( 'aces_casinos_tab', 'casinos_read_review_title', 'esc_attr');

    function aces_textfield_read_review_title_callback($args) {
        $option = esc_attr(get_option($args['option_name']));
        $id = $args['id'];
        $option_name = $args['option_name'];
        ?>
