...
function aces_games_pros_cons_fields() {
    add_meta_box( 'aces_games_pros_cons_meta_box',
        esc_html__( 'Pros/Cons of the game', 'aces' ),
...
<div class="components-base-control game_button_notice">
	<div class="components-base-control__field">
		...
		<textarea class="components-textarea-control__input" id="game_button_notice-0" rows="8" name="game_button_notice" style="display: block; margin-bottom: 10px; width:100%;"><?php echo wp_kses($game_button_notice, $game_allowed_html); ?></textarea>
	</div>
</div>
