...
<div class="wrap">
    ...
    <div class="wpshop-widgets">
        <div class="wpshop-widget">
            ...
            <div class="wpshop-widget__header"><a href="https://docs.wpshop.ru/plugins/expert-review" target="_blank" rel="noopener">Документация</a></div>
            <div class="wpshop-widget__description">Если у&nbsp;Вас возник вопрос по&nbsp;нашему продукту&nbsp;&mdash; возможно ответ уже есть в&nbsp;нашей документации.</div>
        ...
        <div class="wpshop-widget wpshop-widget--color-purple">
            ...
            <div class="wpshop-widget__header"><a href="https://docs.wpshop.ru/plugins/expert-review/faq" target="_blank" rel="noopener">Вопросы и ответы</a></div>
            <div class="wpshop-widget__description">Раздел частозадаваемых вопросов и&nbsp;ответов к&nbsp;ним. Можно быстро найти ответ на&nbsp;вопрос.</div>
        ...
        <div class="wpshop-widget wpshop-widget--color-red">
            ...
            <div class="wpshop-widget__header"><a href="https://www.youtube.com/watch?v=_CDvhz3heYs&list=PLMhKPYPH7i6QMIIQe3oBdQtPy4BwIVHwP" target="_blank" rel="noopener">Видео-инструкции</a></div>
            <div class="wpshop-widget__description">Обзор плагина и&nbsp;функций в&nbsp;видео формате. Подпишитесь на&nbsp;канал, чтобы не&nbsp;пропустить.</div>
    ...
    <div class="wpshop-widget">
        ...
        <a href="https://wpshop.ru/partner" target="_blank" rel="noopener" class="wpshop-widget-partners">Партнерская программа</a>
