							...
							<div class="space-aces-content-meta-ins text-center relative">
								...
								<div class="space-organization-content-logo relative">
									...
									if ( wp_get_attachment_image(get_post_thumbnail_id()) ) {
										echo wp_get_attachment_image( get_post_thumbnail_id(), 'mercury-9999-135', "", array( "alt" => $post_title_attr ) );
									} ?>
								</div>
								...
								<div class="space-organization-content-button-block relative">
									...
									<div class="space-organization-content-button relative">
										<a href="<?php echo esc_url( $casino_external_link ); ?>" title="<?php echo esc_attr( $button_title ); ?>" rel="nofollow" target="_blank"><?php echo esc_html( $button_title ); ?> <i class="fas fa-arrow-alt-circle-right"></i></a>
									</div>
									<?php } ?>
											...
											<div class="tc-desc">
												<?php
													if ($casino_detailed_tc) {
														echo wp_kses( $casino_detailed_tc, $allowed_html );
													}
												?>
											</div>
										</div>
									...
									if ($casino_detailed_tc) { ?>
										...
										<div class="space-organizations-archive-item-detailed-tc box-100 relative">
											<div class="space-organizations-archive-item-detailed-tc-ins relative">
												<?php echo wp_kses( $casino_detailed_tc, $allowed_html ); ?>
											</div>
										</div>
