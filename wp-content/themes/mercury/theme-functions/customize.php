...
/*  Aces Settings  */
	...
	$wp_customize->add_panel( 'mercury_aces', array(
	    'priority'   => 140,
	    'capability' => 'edit_theme_options',
	    'title'      => esc_html__( 'ACES Maker', 'mercury' ),
	));
    ...
    $wp_customize->add_control( 'mercury_casino_archive_style', array(
        'label' => esc_html__( 'The layout style of organization listing pages (archive and taxonomy)', 'mercury' ),
    ...
    $wp_customize->add_control( 'mercury_game_archive_style', array(
        'label' => esc_html__( 'The layout style of unit listing pages (archive and taxonomy)', 'mercury' ),
        'section' => 'mercury_aces_settings',
        'type' => 'radio',
        'choices' => array(
            '1' => esc_html__('#1 Style', 'mercury'),
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'mercury_category_navigation_casinos', array(
		'label' => esc_html__( 'Enable category navigation for Organizations', 'mercury' ),
	    'section'  => 'mercury_aces_settings',
	...
	$wp_customize->add_control( 'mercury_casinos_list_page_id', array(
		'type' => 'dropdown-pages',
		'section' => 'mercury_aces_settings',
		'label' => esc_html__( '"All" page for Organizations', 'mercury' ),
		'description' => esc_html__( 'Please select the page with a list of all organizations', 'mercury' )
	) );
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'mercury_category_navigation_games', array(
		'label' => esc_html__( 'Enable category navigation for Units', 'mercury' ),
	    'section'  => 'mercury_aces_settings',
	...
	$wp_customize->add_control( 'mercury_games_list_page_id', array(
		'type' => 'dropdown-pages',
		'section' => 'mercury_aces_settings',
		'label' => esc_html__( '"All" page for Units', 'mercury' ),
		'description' => esc_html__( 'Please select the page with a list of all units', 'mercury' )
	) );
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'mercury_category_navigation_bonuses', array(
		'label' => esc_html__( 'Enable category navigation for Offers', 'mercury' ),
	    'section'  => 'mercury_aces_settings',
	...
	$wp_customize->add_control( 'mercury_bonuses_list_page_id', array(
		'type' => 'dropdown-pages',
		'section' => 'mercury_aces_settings',
		'label' => esc_html__( '"All" page for Offers', 'mercury' ),
		'description' => esc_html__( 'Please select the page with a list of all offers', 'mercury' )
	) );
...
/*  Other Settings  */
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'mercury_post_views_counter', array(
		'label' => esc_html__( 'Enable post views counter', 'mercury' ),
	    'section'  => 'mercury_posts_settings',
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'mercury_casino_float_bar', array(
		'label' => esc_html__( 'Enable an organization float bottom bar', 'mercury' ),
	    'section'  => 'mercury_posts_settings',
